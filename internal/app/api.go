...
import (
	...
	"github.com/haikalvidya/football-league/internal/delivery"
	...
	"github.com/haikalvidya/football-league/pkg"
...
func (a *httpApp) Init() (err error) {
	...
	a.usecase = usecase.NewUsecase(a.repo, a.middleware, &a.config.Server)
